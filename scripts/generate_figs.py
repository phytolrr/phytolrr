...
def generate_step3_subgroup_type_data(seqs, seq_ids_to_nsites, seq_ids_to_lrrs, all_types, get_n_type, min_lrr_count=20):
    ...
    for subgroup, seqs in subgroups_to_seqs.items():
        ...
        for seq in seqs:
            ...
            # rule out seqences with LRR less than 20
            ...
            # calculate the acc20 of each site in LRR obtained
            lrr_9_offsets = set()
            for lrr in lrrs:
            ...
            # obtain the acc20 and weblogo of sites -5 to +5 around N-glycosylation sites.
